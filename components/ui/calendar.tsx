  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_start: "day-range-start rounded-l-md bg-orange-500 text-white hover:bg-orange-600 hover:text-white focus:bg-orange-600 focus:text-white",
        day_range_end: "day-range-end rounded-r-md bg-orange-500 text-white hover:bg-orange-600 hover:text-white focus:bg-orange-600 focus:text-white",
        day_selected:
        ...
        day_range_middle:
          "aria-selected:bg-orange-100 aria-selected:text-orange-900 dark:aria-selected:bg-orange-800/50 dark:aria-selected:text-orange-50",
